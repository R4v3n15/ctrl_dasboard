        ...
        if (!$this->database) {
            ...
            try {
                ...
                $this->database = new PDO(
                   Config::db('DB_TYPE') . ':host=' . Config::db('DB_HOST') . ';dbname=' .
                   Config::db('DB_NAME') . ';port=' . Config::db('DB_PORT') . ';charset=' . Config::db('DB_CHARSET'),
                   Config::db('DB_USER'), Config::db('DB_PASS'), $options
                   );
