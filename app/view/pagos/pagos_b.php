<div class="row" id="page-content-wrapper">
    <main role="main" class="col-12 col-md-12 px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-2 mb-3 border-bottom">
            <h5 class="text-info">Pagos Enero-Julio <?= date('Y'); ?></h5>
                    ...
                    <table id="tabla_pagos" class="table table-sm table-striped" style="width:100%">
                        <thead>
                            <tr class="info">
                                ...
                                <th class="text-center" width="10">Ene</th>
                                <th class="text-center" width="10">Feb</th>
                                <th class="text-center" width="10">Mar</th>
                                <th class="text-center" width="10">Abr</th>
                                <th class="text-center" width="10">May</th>
                                <th class="text-center" width="10">Jun</th>
                                <th class="text-center" width="10">Jul</th>
                                <th class="text-center" width="160">Comentario</th>
            ...
            <div class="modal-body">
                <div class="row justify-content-center pb-0">
                    <div class="col-12 col-md-8">
                        ...
                        <h6 class="text-center text-warning mb-0" id="response"></h6>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
